...
class ChatListItem extends Component {
    ...
    render() {
        ...
        const reasons =  chat.getReasons(App);//我加的
        ...
        if (chat.isOne2One) {
            ...
            }else if (theOtherOne.isAway){//我加的
                subname = <font color='red'>[离开]:{reasons}</font>;
            }else if (theOtherOne.isBusy){
                subname = <font color='ff7f27'>[忙碌]</font>;;
            }
        //console.log(subname)
