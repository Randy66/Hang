...
class FileListItem extends Component {
    ...
    handleDownloadBtnClick(file) {
        if (Platform.dialog.showSaveDialog) {
            Platform.dialog.showSaveDialog({filename: '【'+file.safe_level+'】'+file.name}, filename => {
                if (filename) {
                    file.path = filename;
    ...
    render() {
        ...
        const safe_level = file.safe_level;//我加的
        ...
        >
            ...
            <div className="content">
                <div className="title">【{safe_level}】{fileName}</div>
